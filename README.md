...
1. **Desktop Bare-Metal Version:** Zero frameworks/third-party dependencies. Direct interfaces to native OS kernels and low-level graphics/GPGPU APIs.
...
* **Compilers:**
  * **Windows:** Visual Studio 2025 / MSVC 14.52+ (or newer).
